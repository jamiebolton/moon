package club.crazypenguin.commons.aspect;

import club.crazypenguin.commons.annotation.DataSourceChange;
import club.crazypenguin.commons.datasource.DynamicDataSource;
import club.crazypenguin.commons.exception.DataSourceAspectException;
...
public class DataSourceAspect {
    ...
    @Pointcut(value = "@annotation(club.crazypenguin.commons.annotation.DataSourceChange)")
